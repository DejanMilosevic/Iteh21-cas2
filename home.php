...
if (!$rezultat) {
    echo "Doslo je do greske prilikom izvrsenja upita! <br>";
    die();
}
...
?>
    ...
    <body>
        ...
        <div class="row" style="background-color: rgba(225, 225, 208, 0.5);">
            <div class="col-md-4">
                <button id="btn" class="btn btn-info btn-block" onclick="prikazi()" style="background-color: teal !important; border: 1px solid white; "> Prikazi kolokvijum</button>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <button id="btn-pretraga" class="btn btn-warning btn-block" onclick="prikaziPretragu()" style="background-color:  teal; border: 1px solid white;"> Pretrazi kolokvijum</button>
        ...
        <script>
            function funkcijaZaPretragu() {
                var input, filter, table, tr, td1, td2, td3, td4, textValue1, textValue2, textValue3, textValue4;
                ...
                for (i = 0; i < tr.length; i++) {
                    ...
                    if (td1 || td2 || td3 || td4) {
                        textValue1 = td1.textContent || td1.innerText;
            ...
            function sortTable() {
                var table, switching, rows, i, shouldSwitch, x, y;
                table = document.getElementById('myTable');
                switching = true;
                while (switching) {
                    switching = false;
